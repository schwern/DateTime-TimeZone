...
DateTime::TimeZone::Atlantic::Reykjavik - Time zone data for Atlantic/Reykjavik

=head1 SYNOPSIS

  my $timezone = DateTime::TimeZone->new( name => 'Atlantic/Reykjavik' );
