...
sub _generate_spans_until_match
{
    ...
    foreach my $rule (@$rules)
    {
        ...
        $next = $rule->date_for_year( $year + 1, 45900 );
...
DateTime::TimeZone::Pacific::Chatham - Time zone data for Pacific/Chatham

=head1 SYNOPSIS

  my $timezone = DateTime::TimeZone->new( name => 'Pacific/Chatham' );
