...
DateTime::TimeZone::Pacific::Rarotonga - Time zone data for Pacific/Rarotonga

=head1 SYNOPSIS

  my $timezone = DateTime::TimeZone->new( name => 'Pacific/Rarotonga' );
