...
DateTime::TimeZone::Pacific::Galapagos - Time zone data for Pacific/Galapagos

=head1 SYNOPSIS

  my $timezone = DateTime::TimeZone->new( name => 'Pacific/Galapagos' );
