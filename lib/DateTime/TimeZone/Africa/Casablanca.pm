...
DateTime::TimeZone::Africa::Casablanca - Time zone data for Africa/Casablanca

=head1 SYNOPSIS

  my $timezone = DateTime::TimeZone->new( name => 'Africa/Casablanca' );
