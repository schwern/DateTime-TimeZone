...
DateTime::TimeZone::Australia::Lindeman - Time zone data for Australia/Lindeman

=head1 SYNOPSIS

  my $timezone = DateTime::TimeZone->new( name => 'Australia/Lindeman' );
