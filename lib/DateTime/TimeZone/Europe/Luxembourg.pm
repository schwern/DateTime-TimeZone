...
DateTime::TimeZone::Europe::Luxembourg - Time zone data for Europe/Luxembourg

=head1 SYNOPSIS

  my $timezone = DateTime::TimeZone->new( name => 'Europe/Luxembourg' );
