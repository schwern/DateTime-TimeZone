...
DateTime::TimeZone::America::North_Dakota::Center - Time zone data for America/North_Dakota/Center

=head1 SYNOPSIS

  my $timezone = DateTime::TimeZone->new( name => 'America/North_Dakota/Center' );
