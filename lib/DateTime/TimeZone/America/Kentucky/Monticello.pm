...
DateTime::TimeZone::America::Kentucky::Monticello - Time zone data for America/Kentucky/Monticello

=head1 SYNOPSIS

  my $timezone = DateTime::TimeZone->new( name => 'America/Kentucky/Monticello' );
