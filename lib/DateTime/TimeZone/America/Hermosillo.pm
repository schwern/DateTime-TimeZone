...
DateTime::TimeZone::America::Hermosillo - Time zone data for America/Hermosillo

=head1 SYNOPSIS

  my $timezone = DateTime::TimeZone->new( name => 'America/Hermosillo' );
