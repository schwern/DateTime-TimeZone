...
DateTime::TimeZone::America::Mazatlan - Time zone data for America/Mazatlan

=head1 SYNOPSIS

  my $timezone = DateTime::TimeZone->new( name => 'America/Mazatlan' );
