...
DateTime::TimeZone::America::Araguaina - Time zone data for America/Araguaina

=head1 SYNOPSIS

  my $timezone = DateTime::TimeZone->new( name => 'America/Araguaina' );
