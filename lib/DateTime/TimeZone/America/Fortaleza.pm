...
DateTime::TimeZone::America::Fortaleza - Time zone data for America/Fortaleza

=head1 SYNOPSIS

  my $timezone = DateTime::TimeZone->new( name => 'America/Fortaleza' );
