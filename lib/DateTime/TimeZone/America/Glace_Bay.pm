...
DateTime::TimeZone::America::Glace_Bay - Time zone data for America/Glace_Bay

=head1 SYNOPSIS

  my $timezone = DateTime::TimeZone->new( name => 'America/Glace_Bay' );
